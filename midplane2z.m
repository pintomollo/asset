function [midx, midy] = midplane2z(ptsx, ptsy, center, axes_length, orient, zpos, thresh)
  ...
  if (size(ptsx, 2) == 4)
    [pts_x, pts_y] = midplane2z(ptsx(:,1), ptsx(:,2), center, axes_length, orient, zpos, thresh);
    [stds_x, stds_y] = midplane2z(ptsx(:,3), ptsx(:,4), [0; 0], axes_length, orient, zpos, thresh);
